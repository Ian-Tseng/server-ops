...
workspace services. Version 0.2.0 is deliberately read-only: it discovers processes,
...
`$CODEX_HOME/backups/server-ops`, outside the active skill registry. Version 0.2.0 also
...
contracts. Version 0.2.0 does not claim a certified start, stop, or restart provider, live
