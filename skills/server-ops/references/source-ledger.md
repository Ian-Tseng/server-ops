...
Reviewed 2026-08-27. Popularity means either official ecosystem stewardship or public
...
| obra Superpowers `systematic-debugging` and condition-based waiting | [`b36e082`](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/systematic-debugging/SKILL.md) and [condition-waiting note](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/systematic-debugging/condition-based-waiting.md); 278,197 stars | collect evidence before repair; test one hypothesis at a time; wait for observable conditions instead of blind delays | automatic repair, arbitrary repository commands, unbounded waits, and treating popularity as correctness |
| Elastic Agent Skills `service-health` | [`96736be`](https://github.com/elastic/agent-skills/blob/96736bec4aa27f236580a3fefc4b14582f0f8aa0/skills/observability/service-health/SKILL.md); 560 stars | expose a separate service-health workflow and preserve explicit evidence windows | remote Elastic/Kibana transport, credentials, production telemetry, and vendor-specific health scoring |

Repository popularity metadata was queried from the GitHub repository API on 2026-08-20
for the original rows and on 2026-08-27 for the two added rows:
`openai/plugins` 5,121 stars; `agno-agi/agentos-railway` 31;
`openai/openai-agents-python` 28,786; `mode-io/skill-manager` 115; and
`openai/skills` 25,050; `obra/superpowers` 278,197; and
`elastic/agent-skills` 560. Star counts are time-varying discovery context, not evidence of
